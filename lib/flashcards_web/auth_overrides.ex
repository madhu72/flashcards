defmodule FlashcardsWeb.AuthOverrides do
  ...
  override AshAuthentication.Phoenix.SignInLive do
    set :root_class, "min-h-screen min-w-full flex items-center justify-center bg-gradient-to-br from-orange-50 via-pink-100 to-yellow-100 px-4 py-8"
  end

  override AshAuthentication.Phoenix.Components.SignIn do
    set :root_class, "mx-auto min-h-192 min-w-128 flex items-center justify-center bg-white bg-opacity-90 rounded-3xl shadow-3xl p-10 md:p-16 flex-col gap-8 border border-orange-100 animate-fade-in"
    ...
    set :input_class, "border border-orange-200 focus:border-orange-400 focus:ring-orange-100 rounded-lg px-4 py-3 text-zinc-700 bg-white placeholder-zinc-400 w-full"
    set :label_class, "font-semibold text-orange-600 mb-2 text-lg"
    set :strategy_class, "mb-6"
    set :authentication_error_container_class, "rounded-lg bg-red-50 border border-red-200 text-red-600 px-4 py-2 mb-4 text-center shadow"
