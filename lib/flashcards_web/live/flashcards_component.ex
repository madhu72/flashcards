defmodule FlashcardsWeb.FlashcardsComponent do
  ...
  def update(assigns, socket) do
    ...
    {flashcards, total_count} = paginated_flashcards(page, @page_size, Map.merge(assigns, %{groups: groups, selected_group_id: selected_group_id}))
    ...
    <div class="w-full max-w-2xl mx-auto mt-8">
      ...
      <div class="mb-4 flex items-center gap-2">
        <form phx-change="select_group" phx-target={@myself}>
          ...
          <select name="group_id" id="group_id" class="rounded border-gray-300 px-2 py-1 text-sm focus:ring-orange-400 focus:border-orange-400">
