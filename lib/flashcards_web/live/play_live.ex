          ...
          <div class="mt-8 flex flex-col items-center">
            <%= if @current_index < length(@flashcards) do %>
              ...
              <div class="flex gap-4 mt-2">
                <button phx-click="show_answer" class="px-4 py-2 rounded bg-gray-400 text-white font-semibold hover:bg-gray-500 transition" disabled={@show_answer}>Show</button>
                <button phx-click="know_card" class="px-4 py-2 rounded bg-green-600 text-white font-semibold hover:bg-green-700 transition">Know</button>
                <button phx-click="dont_know_card" class="px-4 py-2 rounded bg-red-600 text-white font-semibold hover:bg-red-700 transition">Don't Know</button>
              </div>
